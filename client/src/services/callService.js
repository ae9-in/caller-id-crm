...
export const callService = {
  ...
  getPresignedUpload: (data) => api.post('/calls/presigned-upload', data),
  uploadDirect: (data) => api.post('/calls/upload-direct', data),
  uploadZipDirect: (data) => api.post('/calls/upload-zip-direct', data),
